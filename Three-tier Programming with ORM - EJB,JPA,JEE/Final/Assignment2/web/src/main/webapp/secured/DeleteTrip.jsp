...
<div class="container col-md-8 col-md-offset-3" style="overflow: auto; text-align: center" >
    <br>
    <h1>Select a Trip to delete</h1>
    <br>
    <form action="<%=request.getContextPath()%>/delete_trip" method="post">
        <br>
        <table class="table">
            ...
            <c:forEach var="t" items="${Trips}">
                <tr>
                    ...
                    <td><button name="token" value="${t.id}" type="submit" class="btn btn-outline-danger">Delete Trip</button></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
